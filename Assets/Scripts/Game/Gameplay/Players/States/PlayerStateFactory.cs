    ...
    public class PlayerStateFactory : StateFactory<PlayerStateMachine, PlayerBaseState, PlayerStateType, PlayerStateFactory>
    {
        ...
        public override PlayerBaseState Create(PlayerStateType stateType)
        {
            ...
            switch (stateType)
            {
                ...
                case PlayerStateType.Floating:
                    playerState = container.Instantiate<PlayerFloatingState>();
                    break;

                case PlayerStateType.Uncontrollable:
                    playerState = container.Instantiate<PlayerUncontrollableState>();
                    break;
            }
